...
export default function DiscordModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-[340px] bg-[#2b2d31] rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.5)] border border-white/5 animate-in fade-in zoom-in-95 duration-200 overflow-hidden">
        
        {/* Header Tab-like */}
        <div className="px-5 pt-5 pb-3 border-b border-black/20 flex items-center gap-6">
          <span className="text-white font-bold text-[15px] border-b-[3px] border-white pb-2 -mb-[13px]">Activity</span>
        </div>
