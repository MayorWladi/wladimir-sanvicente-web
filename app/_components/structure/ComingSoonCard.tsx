...
export default function ComingSoonCard({ type, previewImage, previewSvg }: ComingSoonCardProps) {
  ...
  return (
    <div
      ...
      className={`widget-card group relative w-full text-center rounded-xl overflow-hidden ring-1 ring-black bg-widget-bg min-h-55 select-none flex flex-col items-center justify-center transition-all duration-300 ${gridSpan} ${hasPreview ? "cursor-pointer" : ""}`}
    >
