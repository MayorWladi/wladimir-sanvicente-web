...
export default async function JournalPage({
  ...
  return (
    <main className="w-full max-w-300 mx-auto p-4 sm:p-6 flex flex-col gap-8 min-h-screen">
      <div className="flex justify-between items-center">
        <Link
          href={`/${lang}/projects`}
          className="widget-card px-4 py-2 border-2 border-black/40 rounded-xl bg-widget-bg text-sm font-bold hover:scale-[1.03] transition-all flex items-center gap-2 select-none"
        >
